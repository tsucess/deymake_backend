...
class DeveloperController extends Controller
{
    private const WEBHOOK_EVENTS = [
        ...
        'creator.verification.updated',
        'tip.received',
        'revenue_share.agreement.created',
        'revenue_share.agreement.updated',
        'revenue_share.settlement.created',
        'brand.campaign.updated',
        'sponsorship.proposal.created',
        'sponsorship.proposal.updated',
        'merch.order.created',
        'merch.order.updated',
